...
def main():
    ...
    for i in range(10):
        path = '/home/arpitmac74_hw0/Phase1/BSDS500/Images/'+str(i+1)+'.jpg'
        print(path)
        img = plt.imread(path)  #0 for reading img in grayscale
        img_col = plt.imread('/home/arpitmac74_hw0/Phase1/BSDS500/Images/'+str(i+1)+'.jpg')
        ...
        """
        sobelBaseline = plt.imread('/home/arpitmac74_hw0/Phase1/BSDS500/SobelBaseline/'+str(i+1)+'s.png',0)

        """
        Read Canny Baseline
        use command "cv2.imread(...)"
        """
        cannyBaseline = plt.imread('/home/arpitmac74_hw0/Phase1/BSDS500/CannyBaseline/'+str(i+1)+'.png',0)
